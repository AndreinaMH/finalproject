...
CREATE TABLE `employee` (
  `dogcare_id` bigint(20) DEFAULT NULL,
  ...
  KEY `FK4nh0tjcwdbveqk2kjeelpl583` (`dogcare_id`),
  CONSTRAINT `FK4nh0tjcwdbveqk2kjeelpl583` FOREIGN KEY (`dogcare_id`) REFERENCES `dogcare` (`dogcare_id`)
